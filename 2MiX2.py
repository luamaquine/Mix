...
def main():
    ...
    while run_game:
        ...
        for pos in snake_body:
            ...
            if i != 0:
                WIN.blit(pygame.image.load("assets/snake/snakebody.png"), [pos[0], pos[1]])
            else:
                if direction == 'UP':
                    WIN.blit(pygame.image.load("assets/snake/snakespriteup.png"), [pos[0], pos[1]])
                if direction == 'DOWN':
                    WIN.blit(pygame.image.load("assets/snake/snakespritedown.png"), [pos[0], pos[1]])
                if direction == 'LEFT':
                    WIN.blit(pygame.image.load("assets/snake/snakespriteleft.png"), [pos[0], pos[1]])
                if direction == 'RIGHT':
                    WIN.blit(pygame.image.load("assets/snake/snakespriteright.png"), [pos[0], pos[1]])

            i += 1

        WIN.blit(pygame.image.load(fruit), [fruit_position[0], fruit_position[1]])
